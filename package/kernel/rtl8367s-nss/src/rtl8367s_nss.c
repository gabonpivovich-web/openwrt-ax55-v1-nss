 ...
 *
 * The module then stays resident to poll BMCR on the front PHYs and drive
 * the case LEDs, since without DSA there are no per-port netdevs for the
 * kernel's netdev LED trigger to follow.
 *
